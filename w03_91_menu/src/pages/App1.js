  ...
  return (
    <section className="menu">
      ...
      <div className="section-center">
        ...
        <article className="menu-item">
          <img
            src="/theme-menu/images/my-2.jpg"
            alt="big"
            salad=""
            className="photo"
          />
        ...
        <article className="menu-item">
          <img
            src="/theme-menu/images/my-3.jpg"
            alt="fried"
            dish=""
            className="photo"
          />
        ...
        <article className="menu-item">
          <img
            src="/theme-menu/images/item-1.jpeg"
            alt="buttermilk"
            pancakes=""
            className="photo"
          />
        ...
        <article className="menu-item">
          <img
            src="/theme-menu/images/item-2.jpeg"
            alt="dinner"
            double=""
            className="photo"
          />
        ...
        <article className="menu-item">
          <img
            src="/theme-menu/images/item-3.jpeg"
            alt="godzilla"
            milkshake=""
            className="photo"
          />
